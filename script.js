async function fetchVisitor() {
    const fetchData = await fetch("./[2024 지방기능경기대회] 웹 디자인 및 개발 선수제공파일/B_Module/visitors.json");
  ...
  async function getGoodsJson() {
    // 데이터 불러오기
    const a = await fetch("./[2024 지방기능경기대회] 웹 디자인 및 개발 선수제공파일/B_Module/goods.json");
  ...
  async function updateGoodsList() {
    ...
    for (let i = 0; i < outputData.length; i++) {
      ...
      if (i < 3) {
        ...
        <img src="./[2024 지방기능경기대회] 웹 디자인 및 개발 선수제공파일/B_Module/${outputData[i].img}" class="card-img-top" alt="...">
        <div class="card-body">
